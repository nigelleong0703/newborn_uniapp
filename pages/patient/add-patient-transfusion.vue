            ...
            <view class="form-content">
                <u--form labelPosition="left" :model="transfusion1" ref="form1">
                    ...
                    <u-form-item prop="ward.time" ref="item2" @click="time_picker = true; hideKeyboard()" borderBottom>
                        <u--input v-model="transfusion1.ward.time_display" placeholder="时间" disabled
                    ...
                    <u-form-item prop="drug.seq" ref="item7" borderBottom> 输液剂数
                        <u-number-box v-model="transfusion1.drug.seq" @change='seq_picker' integer step="1" :min="1"
                            slot="right">
                        </u-number-box>
                    </u-form-item>
                ...
                <u-datetime-picker :show="time_picker" mode="datetime" v-model="transfusion1.ward.time"

      ...
      <view class="form-content">
        <u--form labelPosition="left" :model="transfusion1" ref="form1">
          ...
          <u-form-item label="患者" label-width="120" prop="patientId" ref="item1">
            <u--input v-model="transfusion1.patientId" disabled disabledColor="#ffffff" placeholder="患者ID"></u--input>
          </u-form-item>
          <u-form-item label="护士/医生" label-width="120" prop="nurseId" ref="item2">
            <u--input v-model="transfusion1.nurseId" disabled disabledColor="#ffffff" placeholder="负责医生/护士"></u--input>
          </u-form-item>
          <u-form-item label="输液时间" label-width="120" prop="startTime" ref="item3"
            @click="time_picker = true; hideKeyboard()" borderBottom>
            <u--input v-model="transfusion1.startTime_display" placeholder="时间" disabled disabledColor="#ffffff">
            </u--input>
          </u-form-item>
          ...
          <view v-for="(drug, index) in transfusion1.drug" :key="drug.seq">
            ...
            <u-form-item label="输液速度（滴/分钟）" label-width="120" :prop="'drug.' + index.toString() + '.rate'">
              <u--input v-model="drug.rate" placeholder="输液速度"></u--input>
            </u-form-item>
            <u-form-item label="输液量（ml）" label-width="120" :prop="'drug.' + index.toString() + '.dose'">

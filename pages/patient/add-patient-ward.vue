            ...
            <view class="form-content">
                <u--form labelPosition="left" :model="patrol1" ref="form1">
                    <u-form-item label="患者" label-width="120" prop="patientId" ref="item1">
                        <u--input v-model="patrol1.patientId" disabled disabledColor="#ffffff"
                            placeholder="患者ID"></u--input>
                    </u-form-item>
                    <u-form-item label="护士/医生" label-width="120" prop="nurseId" ref="item2">
                        <u--input v-model="patrol1.nurseId" disabled disabledColor="#ffffff"
...
export default {
    ...
    onLoad(options) {
        ...
        this.patrol1.nurseId = String(this.$db.get('current_user').id)

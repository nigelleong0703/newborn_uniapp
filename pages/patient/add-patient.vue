    ...
    <view class="form">
      <view class="form-content">
        <u--form labelPosition="left" :model="form1" ref="form1">
          ...
          <u-form-item label="入院日期" label-width="120" prop="inDate" @click="inDate_picker = true; hideKeyboard()"
            ref="item8">
        ...
        <u-datetime-picker ref="datetimePicker" :show="time_picker" mode="date" :minDate="mindate" :maxDate="maxdate" closeOnClickOverlay
          @close="time_picker = false" @cancel="time_picker = false" @confirm='time_select' @change='change'
          :formatter="formatter">
        </u-datetime-picker>
        <u-datetime-picker ref="inDatePicker" v-model="post.inDate" :show="inDate_picker" mode="datetime" closeOnClickOverlay
          @close="inDate_picker = false" @cancel="inDate_picker = false" @confirm='inDate_select' @change='change'
          :formatter="formatter">
        </u-datetime-picker>
      </view>
    </view>

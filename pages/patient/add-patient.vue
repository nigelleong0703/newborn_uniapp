    ...
    <view class="form">
      <view class="form-content">
        <u--form labelPosition="left" :model="model1" ref="form1">
          ...
          <u-form-item prop="guardianInfo.relation" ref="item7" @click="guardian_picker = true; hideKeyboard()"
            borderBottom>
            <u--input v-model="model1.guardianInfo.relation" disabled disabledColor="#ffffff" placeholder="请选择监护人信息"
              border="none">
            </u--input>

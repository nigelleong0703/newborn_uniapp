    ...
    <view class="content">
        <view class="form">
            <view class="form-content">
                ...
                <u-datetime-picker ref="datetimePicker" :show="time_picker" v-model="post.birthdate" mode="date"
                    :minDate="mindate" :maxDate="maxdate" closeOnClickOverlay @close="time_picker = false"
                    @cancel="time_picker = false" @confirm='time_select' @change='change' :formatter="formatter">
                </u-datetime-picker>
            </view>
        </view>
...
export default {
    ...
    onLoad(option) {
        ...
        this.patient_id = patient_detail.id
        ...
        this.form1.birthdate = this.$common.dateStr(patient_detail.birthdate);
    ...
    onUnload() {
        this.$db.del('selected_patientInfo')
    },
    methods: {
        navigateBack() {
            uni.navigateBack()
        ...
        submit() {
            ...
            that.$refs.form1.validate().then(res => {
                ...
                that.post.tel = parseInt(this.form1.tel, 10)
                that.post.room = parseInt(this.form1.room, 10)
                that.post.bed = parseInt(this.form1.bed, 10)

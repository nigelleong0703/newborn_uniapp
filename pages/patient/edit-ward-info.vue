      ...
      <view class="form-content">
        <u--form labelPosition="left" :model="editpatrol1" ref="form1">
          <u-form-item label="患者" label-width="120" prop="patientId" ref="item1">
            <u--input v-model="editpatrol1.patientId" disabled disabledColor="#ffffff" placeholder="患者ID"></u--input>
          </u-form-item>
          <u-form-item label="护士/医生" label-width="120" prop="nurseId" ref="item2">
            <u--input v-model="editpatrol1.nurseId" disabled disabledColor="#ffffff" aplaceholder="同班医生/护士"></u--input>
          </u-form-item>
